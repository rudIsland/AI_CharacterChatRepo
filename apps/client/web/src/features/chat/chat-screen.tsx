...
export function ChatScreen() {
  ...
  return (
    <main className="h-dvh overflow-hidden bg-[radial-gradient(circle_at_top_left,_#1e293b,_transparent_55%),radial-gradient(circle_at_bottom_right,_#0f172a,_transparent_45%),#020617] px-2 py-2 sm:px-4 sm:py-3">
      ...
      <section className="mx-auto flex h-[calc(100dvh-1rem)] min-h-0 w-full max-w-6xl flex-col gap-2 overflow-hidden rounded-xl border border-slate-800 bg-slate-900 p-2 shadow-panel sm:h-[calc(100dvh-1.5rem)] sm:gap-3 sm:rounded-2xl sm:p-4">
        <ChatCharacterList
        ...
        <section className="grid min-h-0 flex-1 grid-rows-[minmax(0,1fr)] gap-2 overflow-hidden sm:gap-3 md:grid-rows-[auto_minmax(0,1fr)] lg:grid-cols-[280px_minmax(0,1fr)] lg:grid-rows-1">
          ...
          <section className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-slate-800 bg-slate-900 p-2 sm:rounded-2xl sm:p-3">
