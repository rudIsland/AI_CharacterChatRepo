...
export function ChatMessageList({
  ...
  return (
    <div
      ref={messageListRef}
      className="chat-scroll flex h-full min-h-0 flex-col overflow-y-auto rounded-xl border border-slate-800 bg-slate-950/50 p-2 pb-8 shadow-inner sm:rounded-2xl sm:p-3 sm:pb-9"
    >
