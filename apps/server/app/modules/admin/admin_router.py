...
from app.modules.admin.admin_schema import DailyRequestIpResetRequest, DailyRequestUsageResponse
...
def build_daily_request_usage_response(
    admin_client_ip_address: str,
    ...
    ip_usage_list = [
        {
            ...
            "daily_request_count": usage_snapshot.daily_request_count_by_ip.get(
                ip_address,
                0,
            ),
            ...
            "last_access_at": usage_snapshot.last_access_at_by_ip.get(
                ip_address
            ).isoformat()
